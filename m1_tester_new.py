...
for c in range(0, grades_table.num_columns):
    for i in range(0, number_of_aggregates):
        ...
        if column_sum != result:
            print('in version -1, sum error on [', keys[r[0]], ',', keys[r[1]], ']: ', result, ', correct: ', column_sum)
        else:
            pass
        ...
        if column_sum != result:
            print('in version -2, sum error on [', keys[r[0]], ',', keys[r[1]], ']: ', result, ', correct: ', column_sum)
        else:
            pass
        # version 0 sum
        ...
        if updated_column_sum != updated_result:
            print('in version 0, sum error on [', keys[r[0]], ',', keys[r[1]], ']: ', updated_result, ', correct: ', updated_column_sum)
        else:
            pass
